...
<div style='overflow:hidden;height:440px;width:700px;'>
    ...
    var myOptions = { zoom: 2, center: new google.maps.LatLng(58.16420802773941, 26.829760962500018), mapTypeId: google.maps.MapTypeId.ROADMAP };
    map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);
    marker = new google.maps.Marker({ map: map, position: new google.maps.LatLng(58.16420802773941, 26.829760962500018) });
